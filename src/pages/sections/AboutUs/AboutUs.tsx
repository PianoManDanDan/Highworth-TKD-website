...
export const AboutUs: React.FC<{}> = () => {
	return (
		<div className="section">
			<div id="about" className="navbar-offset">
				<SectionHeading text="About Us" />
				<div className="section-body">
					Tae Kwon-Do is a Korean Martial art, officially founded by General
					Choi Hong Hi in 1955. Tae Kwon-Do (literally,
					...
					flexibility, whilst also learning self-defense. We offer family
					friendly classes for people of all ages. Our classes offer a great way
					to make new friends, while getting fit at the same time.
					<br />
